...
An interesting attack that can happen here is if a party intercepts the message. They have their own key $k$, and over the insecure channel they intercept the messages, sharing $g^(a k)$ and $g^(b k)$ instead.
